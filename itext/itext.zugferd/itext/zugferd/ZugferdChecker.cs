...
namespace iText.Zugferd {
    /// <summary>
    /// The
    /// <see cref="iText.Pdfa.Checker.PdfA3Checker"/>
    /// implementation for ZUGFeRD documents.
    /// </summary>
    public class ZugferdChecker : PdfA3Checker {
        /// <summary>The attachments.</summary>
        protected internal IList<PdfDictionary> attachments;

        /// <summary>
        /// Creates a new
        /// <see cref="ZugferdChecker"/>
        /// instance.
        /// </summary>
        ...
        public ZugferdChecker(PdfAConformanceLevel conformanceLevel)
            ...
            attachments = new List<PdfDictionary>();
        }
