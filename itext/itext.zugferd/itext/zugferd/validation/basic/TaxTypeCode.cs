...
namespace iText.Zugferd.Validation.Basic {
    ...
    public class TaxTypeCode : CodeValidation {
        ...
        public const String INSURANCE_TAX = "ZF_INSURANCE_TAX";

        /// <summary>The Constant TAX_ON_REPLACEMENT_PART.</summary>
        public const String TAX_ON_REPLACEMENT_PART = "AAJ";

        /* (non-Javadoc)
        * @see com.itextpdf.zugferd.validation.CodeValidation#isValid(java.lang.String)
        */
        public override bool IsValid(String code) {
            return code.Equals(VALUE_ADDED_TAX) || code.Equals(INSURANCE_TAX) || code.Equals(TAX_ON_REPLACEMENT_PART);
        }
    }
}
